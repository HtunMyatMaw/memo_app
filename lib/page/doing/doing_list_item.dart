...
class DoingListItem extends StatefulWidget {
  final TaskDataModel itemModel;
  final DoingBloc bloc;

  const DoingListItem({Key key, this.itemModel, this.bloc}) : super(key: key);

  @override
  _DoingListItemState createState() => _DoingListItemState();
}

class _DoingListItemState extends State<DoingListItem> {
